...
const float npart[NCENT] = {
    2.918, 3.946, 5.147, 6.823, 9.135,
    12.33, 16.56, 22.13, 29.11, 37.56,
    47.61, 59.51, 73.33, 89.19, 107.3,
    127.8, 151.1, 177.4, 206.7, 237.1
};

const float nparterr[NCENT] = {
    0.0499, 0.0806, 0.235, 0.411, 0.661,
      1.01,   1.49,   1.9,  2.39,  2.59,
      3.03,   3.12,  3.09,  3.05,   2.6,
      2.32,    1.9,  1.54,  1.74,  1.78
};
